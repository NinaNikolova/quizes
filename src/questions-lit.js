const questionsLit = [
    ...
    {
        text: "За кое от изучените в 5. клас произведения се отнася изречението: „Доброто е въплътено в девойката, която има вълшебна „животворна сила“, и в разумния Ӝ баща, който събира хората и така възниква щастливият град на благоденствието“?",
        options: [
